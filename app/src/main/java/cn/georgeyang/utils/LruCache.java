...
/**
 * Created by george.yang on 2015/8/17.
 */
...
public class LruCache {
    ...
    public synchronized void put(String key,Object value) {
        put(key, Integer.MAX_VALUE, value);
    }
     ...
     * @param value
     */
    public synchronized void put(String key,long timeout, Object value) {
    ...
    private synchronized void remove(Entry node) {
        if (node != null) {
            if (node.prev != null) {
