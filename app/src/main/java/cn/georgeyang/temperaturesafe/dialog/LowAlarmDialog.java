 ...
 */
public class LowAlarmDialog extends Dialog implements View.OnClickListener {
    ...
    public LowAlarmDialog(Activity context,float value) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        conentView = inflater.inflate(R.layout.dialog_lowalarm, null);
